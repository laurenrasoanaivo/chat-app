...
const NavigationBar = () => {
  ...
  return (
    <nav className="fixed-top navbar navbar-expand-lg navbar-dark bg-dark mt-0 p-2">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form className="d-flex" onSubmit={handleSignout}>
            <button type="submit" className="logoutButton btn btn-outline-light">Logout</button>
          </form>
        </div>
      </div>
    </nav>
